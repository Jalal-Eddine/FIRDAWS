...
<!-- 
      ...
      -->
        ...
        <header class="header">
            ...
            <h1 class="heading-1">The new way of education</h1>
            <button class="btn header__btn">View Our Courses</button>
            <div class="header__seenon-text">Seen on</div>
            <div class="header__seenon-logos">
                <img src="<?php echo url_for('/img/logo-bbc.png'); ?>" alt="Seen on logo 1">
                <img src="<?php echo url_for('img/logo-forbes.png'); ?>" alt="Seen on logo 2">
                <img src="<?php echo url_for('img/logo-techcrunch.png'); ?>" alt="Seen on logo 3">
                <img src="<?php echo url_for('img/logo-bi.png'); ?>" alt="Seen on logo 4">
            </div>
        </header>
        <div class="about">
            ...
            <div class="about__list">
                ...
                <div class="about__details">
                    ...
                    <p class="about__sold">Student, Web Engineering</p>
                </div>
            </div>
        </div>
